...
INSERT INTO pratica_sustentavel (id_categoria, nome, descricao, pontos_base, dificuldade, frequencia_esperada)
VALUES (1, 'Apagar luzes', 'Desligar luzes ao sair do cômodo', 10, 'FACIL', 'Diária'),
       (2, 'Reduzir banho', 'Banhos de no máximo 5 minutos', 20, 'MEDIA', 'Diária'),
       (3, 'Separar lixo reciclável', 'Separar papel, plástico e vidro', 15, 'FACIL', 'Diária'),
       (1, 'Usar LED', 'Trocar lâmpadas por LED', 50, 'MEDIA', 'Mensal'),
       (4, 'Usar transporte público', 'Ir ao trabalho de ônibus/metrô', 30, 'MEDIA', 'Semanal');
...
VALUES
-- Família Silva
('12345678901', 1, '2025-02-10', 5, 50),   -- João apagou luzes
('98765432100', 2, '2025-02-11', 1, 20),   -- Maria banho rápido
('11122233344', 3, '2025-02-12', 3, 45),   -- Pedro separou lixo

-- Família Santos
('22233344455', 1, '2025-02-10', 3, 30),   -- Carlos apagou luzes
('33344455566', 3, '2025-02-11', 2, 30),   -- Ana separou lixo
('22233344455', 5, '2025-02-12', 1, 30),   -- Carlos usou transporte público

-- Família Costa
('44455566677', 4, '2025-02-10', 2, 100),  -- Luis trocou lâmpadas LED
('55566677788', 2, '2025-02-11', 1, 20),   -- Julia banho rápido
('66677788899', 3, '2025-02-12', 1, 15);   -- Lucas separou lixo
